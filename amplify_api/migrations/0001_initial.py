    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default=b'', unique=True, max_length=100, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('oauth', models.CharField(default=b'', max_length=100, serialize=False, primary_key=True, blank=True)),
